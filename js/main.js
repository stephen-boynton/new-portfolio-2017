...
projectsDiv.addEventListener("mouseover", function(event) {
    ...
    `;
		...
		projectDescription.innerHTML = `
    <h4><strong>_snipe_ - Individual Project</strong></h4>
    ...
    <h6>Tech Used: JavaScript, Node, Bootstrap 4, Mongoose, MongoDB</h6>
      `;
		...
		projectDescription.innerHTML = `
    <h4><strong>The Moon Collection - Individual Project</strong></h4>
    ...
    <h6>Tech Used: JavaScript, Node, MongoDB</h6>
		...
		projectDescription.innerHTML = `
    <h4><strong>RADtunes - Individual Project</strong></h4>
    ...
    <br>
		...
		projectDescription.innerHTML = `
    <h4><strong>Simple AI Chatbot - Individual Project</strong></h4>
    ...
    <h6>Tech Used: JavaScript, Node, Socket.io</h6>
		...
		projectDescription.innerHTML = `
    <h4><strong>Charleston Tweets - Individual Project</strong></h4>
