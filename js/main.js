...
projectsDiv.addEventListener("mouseover", function(event) {
    ...
    `;
		...
		projectDescription.innerHTML = `
    <h4>_snipe_ - Individual Project</h4>
    ...
    <h6>Tech Used: JavaScript, Node, Bootstrap 4, Mongoose, MongoDB</h6>
      `;
		...
		projectDescription.innerHTML = `
    <h4>The Moon Collection - Individual Project</h4>
    ...
    <h6>Tech Used: JavaScript, Node, MongoDB</h6>
		...
		projectDescription.innerHTML = `
    <h4>RADtunes - Individual Project</h4>
    ...
    <br>
		...
		projectDescription.innerHTML = `
    <h4>Simple AI Chatbot - Individual Project</h4>
    ...
    <h6>Tech Used: JavaScript, Node, Socket.io</h6>
		...
		projectDescription.innerHTML = `
    <h4>Charleston Tweets - Individual Project</h4>
